...
<html lang="pr-br">
    ...
    <body>
        <?php
            ...
            $comando3="SELECT*FROM tbl_produto WHERE idProduto=$idProduto";
            $registros3=mysqli_query($conexao,$comando3);
            $linha3=mysqli_fetch_assoc($registros3);
                    ...
                    <div class="formularioNovoProduto">
                        ...
                        <form action="editarProduto.php" method="post" enctype="multipart/form-data">
                            <div class="styleFormularioCadastroProduto">
                                ...
                                <input id="idNomeProduto" type="text" name="nomeProduto"value="<?=$linha3['descProduto']?>"placeholder="Ex: Camiseta manga...">
                            </div>
                            <div class="styleFormularioCadastroProduto">
                                <label for="idPrecoProduto">Preço do Produto:</label>
                                <input id="idPrecoProduto"type="number" value="<?=$linha3['preco']?>"name="precoProduto"num="1" step=".01">
                            </div>
                            <div class="styleFormularioCadastroProduto">
                                <label for="idPeso">Peso do Produto:</label>
                                <input id="idPeso"type="number" value="<?=$linha3['peso']?>"name="pesoProduto"num="1" step=".01">
                            </div>
                            <div class="styleFormularioCadastroProduto">
                                <label for="idProdutoAtivo">Produto Ativo?:</label>
                                <input id="idProdutoAtivo" type="text" value="<?=$linha3['ativo']?>"name="produtoAtivo"placeholder="Sim/Não">
                            </div>
                            <div class="styleFormularioCadastroProduto">
